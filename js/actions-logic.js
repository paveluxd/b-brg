//Actions DATA
    ...
    class ActionLogic {
            ...
            }a23(){// (ene -dice) "curse of chain"
    
                //Resolve stat change
                changeStat('dice', -gs.sourceAction.actionMod, 'enemy')
            }a24(){// (ene roll-) slowness "curse of slowness"
            ...
            }a39(){// adrenaline shot/ adrenaline pen

                //Resolve stat change
                changeStat('roll', gs.sourceAction.actionMod, 'player')
            }a40(){// water potion "water potion"
